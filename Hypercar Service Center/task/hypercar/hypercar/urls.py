...
from tickets.views import ServiceView
from tickets.views import OperatorsView
...
urlpatterns = [
    ...
    path('get_ticket/<service_type>', ServiceView.as_view()),
    path('processing', OperatorsView.as_view()),
